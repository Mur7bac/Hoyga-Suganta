    ...
    <div className={classes.appHeader}>
      <div className={classes.headerBar}>
        ...
        <ul className={classes.pullRight, "pull-right"}>
            <li className={classes.singUp}><a href="signup.html" className={classes.singUpLink}>Signup</a></li>
            <li className={classes.singIn}><a href="signin.html" className={classes.singInLink}><span className={classes.singInButton}>Signin</span></a></li>
        </ul>
      </div>
